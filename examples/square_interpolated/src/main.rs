...
// here we define our square in terms of two triangles
const SQUARE: [Vertex; 6] = [// these first three vertices represent our first triangle
                             Vertex {
                                 position: [-0.5, -0.5],
                                 color: [1.0, 0.0, 0.0],
                             },
...
pub fn main() {
    let builder = glutin::WindowBuilder::new()
        ...
        .with_title("Square Interpolated")
        .with_vsync();
